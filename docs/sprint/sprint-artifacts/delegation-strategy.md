...
* **[CHK-02-A/B/C] Payment Collection Integration** (Supersedes CHK-01 - Ensure Cart uses PaymentCollection)
* *Why combine?* You cannot simply "trust the server" (SEC-01) without fixing the units (MNY-01) and ensuring the cart flows correctly (CHK-02). They modify the exact same lines.
