...
## Objective
Act as a **Senior Security Auditor**. Review the changes made to the checkout flow to ensure **SEC-01** (Client Trust), **MNY-01** (Money Units), and **CHK-01** (Canonical Checkout) are implemented correctly.
...
3.  **CHK-01**: Implementing `medusa.carts.complete()`.
...
### 4. Architecture Audit (CHK-01) - `checkout.tsx`
