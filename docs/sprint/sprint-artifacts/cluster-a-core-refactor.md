...
3.  **[CHK-01: Canonical Checkout](./fix-CHK-01-canonical-checkout.md)**
    *   *Focus*: `checkout.tsx` completion logic.
...
1.  **Refactor**: Execute changes in `apps/storefront` based on SEC-01 and CHK-01.
