...
- ⚠ Minor ambiguity: recovery cadence/window relies on existing fallback cron but frequency is not restated; consider noting current cron interval/SLA to avoid confusion.
