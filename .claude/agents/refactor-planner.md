...
- **Save the plan** in an appropriate location within the project structure,- **Refactoring Plans**:
  - `docs/architecture/refactoring/[feature-name]-refactor-plan.md` for feature-specific refactoring
